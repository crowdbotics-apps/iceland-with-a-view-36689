...
## Project Structure
    ...
    ├── iceland_with_a_view_36689  # Django project configurations
...
1. Clone this repo and `cd iceland_with_a_view_36689`
...
2. Clone this repo and `cd iceland_with_a_view_36689`
